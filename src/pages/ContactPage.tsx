    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main className="pt-20">
        <PageHero
          ...
          badgeIcon={Mail}
          title={<>Parlons de vos <HeroHighlight>besoins logistiques</HeroHighlight></>}
          subtitle="Notre équipe est disponible pour vous accompagner et répondre à toutes vos questions."
        />
