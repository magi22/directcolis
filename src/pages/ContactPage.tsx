          ...
          <div className="max-w-3xl mx-auto px-4 text-center relative z-10">
            <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
              <div className="inline-flex items-center gap-2 bg-red-500/15 border border-red-500/30 px-4 py-2 rounded-full mb-6 backdrop-blur-sm">
                ...
                <span className="text-xs font-bold text-red-300 uppercase tracking-widest">Contactez-nous</span>
              </div>
              <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-white mb-4 leading-[1.1]">
                Parlons de vos <span className="text-red-400 text-glow-red">besoins logistiques</span>
              </h1>
              <p className="text-blue-100/80 text-base sm:text-lg">Notre équipe est disponible pour vous accompagner et répondre à toutes vos questions.</p>
            </motion.div>
          </div>
        </section>
